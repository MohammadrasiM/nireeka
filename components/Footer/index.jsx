...
const navigation = {
  ...
  SUPPORT: [
    ...
    { name: "FAQ", to: "/faq" },
    { name: "User's Manual", to: "/user-manual" },
...
const buttonScroll = [{ pathName: "help-center" }, { pathName: "warranty" }];
...
function Footer() {
  ...
  for (let path of noFooterLayout) {
  ...
  //   });
  // };
  // const renderShowBtnScroll = () => {
  //   for (let i = 0; i < buttonScroll.length; i++) {
  //     let btnScroll = buttonScroll[i];
  //     if ((btnScroll = router.pathname.includes(buttonScroll.pathName))) {
  //       return (
  //         showButton && (
  //           <button
  //             onClick={scrollToTop}
    ...
    <footer className="bg-black" aria-labelledby="footer-heading">
      ...
      <div className="px-4 pb-6 mx-auto max-w-7xl sm:px-6 lg:pb-8 lg:px-8">
        <div className="flex flex-wrap-reverse mx-auto">
          ...
          <div className="items-center w-full px-4 m-auto text-gray-200 md:w-1/2 ">
            ...
            <p className="font-light pt-2 text-center text-gray-400 normal-case">
      ...
      <div className="px-4 py-6 mx-auto max-w-7xl sm:px-6 lg:py-8 lg:px-8">
                    ...
                    (item, index) => (
                      <li key={index}>
                        <div className="text-sm text-gray-400 hover:text-white">
                          <Link href={`/configurator/${item.slug}`}>
                            <a
          ...
          <div className="mt-8 md:mt-0">
            ...
            >
              ...
              <div className="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
                <button
                  type="submit"
                  className="flex items-center justify-center w-full px-4 py-2 text-base font-light text-white border rounded-md border-sky-500 focus:outline-none focus:ring hover:text-indigo-500 focus:ring-indigo-600"
                >
                  Subscribe
                </button>
              </div>
            ...
            <div className="relative hidden lg:flex lg:top-7">
              ...
              >
                ...
                <div className="surly-badge__footer">
                  <h3 className="surly-badge__footer-title">
                    Content &amp; Links
                  </h3>
        ...
        <div className="mt-4 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 font-light text-gray-400 md:mt-0 md:order-1">
