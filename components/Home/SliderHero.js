        ...
        <SwiperSlide>
          <div className="relative">
            ...
            <div className=" absolute bg-transparent  top-[11rem] w-full left-12 h-auto  hidden md:block ">
              <div>
                <p className="text-2xl font-light text-[#b4b4b4] ">{dataSlider[1]?.title || ""}</p>
                <p className="text-5xl font-light text-white ">{dataSlider[1]?.product?.toUpperCase() || ""}</p>
          ...
          <div className=" md:hidden absolute bg-transparent lg:bg-gray-200 lg:bg-opacity-10 top-[2.7rem]  w-full lg:w-[27rem] h-auto   pt-8 ">
            <div className="flex-col justify-center lg:justify-start text-center lg:text-left lg:flex-col lg:flex text-gray-50 min-h-[520px] h-[90vh] lg:h-[63vh] lg:min-h-[490px]">
              <div className=" h-750 lg:w-full">
                <h2 className={`text-3xl text-2 text-white lg:text-2.75 font-exo font-extralight`}>
                  {dataSlider[1]?.product?.toUpperCase() || ""}
                </h2>
                <p className="text-white">Order online now for earlybird offers</p>
              </div>
            ...
            <div className=" absolute bg-transparent lg:bg-gray-200 lg:bg-opacity-10 top-[2.2rem] lg:top-[7.5rem] w-full lg:w-[27rem] lg:left-20 h-auto lg:pr-11 md:pr-0  pt-8 lg:pl-8">
              <div className="flex-col justify-center lg:justify-start text-center lg:text-left lg:flex-col lg:flex text-gray-50 min-h-[520px] h-[90vh] lg:h-[63vh] lg:min-h-[490px]">
                <div className=" h-800 lg:w-full">
                  <h2 className={`text-3xl text-2 lg:text-2.75 font-exo font-extralight`}>
                  ...
                  <div className="hidden lg:flex lg:flex-col">
                    <h3 className={`font-light text-[14px] leading-[1.2rem] pt-[20px] text-gray-300`}>
                      {dataSlider[0]?.title || ""}
                    </h3>
                    <p className={`font-light text-[14px] leading-[1.2rem] pt-[25px] text-gray-300`}>
                      {dataSlider[0]?.description || ""}
                    </p>
                  </div>
                  <div className="hidden lg:flex lg:flex-col">
                    <p className={`font-light text-[14px] leading-[1.2rem] pt-[20px] text-gray-300`}>Starting from</p>
                    <p className={`font-normal text-5xl leading-[1.2rem] pt-[25px] text-[#4ca607]`}>
                      {dataSlider[0]?.sign || ""}
                      {dataSlider[0]?.price || ""}
                      {` *`}
                    </p>
                    <span className={`font-extralight text-[12px] pt-4`}>{dataSlider[0]?.tag || ""}</span>
                  </div>
                </div>
                ...
                <div className="flex flex-row justify-center w-full mb-8 break-words bg-transparent lg:w-1/2 lg:ml-12 glass text-gray-50">
                  <div>
                    <Link href={`/configurator/${dataSlider[0]?.slug || ""}`}>
                      ...
                      >
                        <p className={`font-normal text-gray-300 font-inter`}>Order Now</p>
                      </a>
                    </Link>
                  </div>
                  <div>
                    <Link href={`/configurator/${dataSlider[0]?.slug || ""}`}>
                      ...
                      >
                        <p className={`font-normal text-gray-300 font-inter`}>Details</p>
                      </a>
                    </Link>
                  </div>
                </div>
