export const warranty = {
  ...
  GENERAL: [
    {
      ...
      title_1: "We have a ",
      title_2:
        "warranty on our bikes. Some parts are excluded. Please check the terms below for more information.",
      id: "1",
      slice_text: " one-year ",
      slice_text_2: " 1,600 Miles (2,600 Kilometers) ",
    },
  ],
  MAIN: [
    {
      name: "MAIN FRAME",
      title_1:
        "We have a lifetime warranty on all frames for the entire ownership of the original purchaser. This covers manufacturing and material defects on bikes manufactured. Rider and equipment weight limit:",
      title_2: " 265lbs/120kg total weight including the rider and equipment.",
      title_3: "The frame number should be visible and clear.",
      id: "2",
  ...
  MOTOR: [
    {
      ...
      title_1: "We have a",
      title_2:
        "warranty on the motor. The serial number printed on the motor should be seen clearly or the warranty will be voided.",
      slice_text: " one-year ",
      slice_text_2: " 1,600 Miles (2,600 Kilometers) ",
      id: "3",
    },
  ...
  FORKS: [
    {
      name: "FORKS",
      title_1: "Carbon Fiber forks are guaranteed for",
      title_2: " from the date of purchase or ",
      title_href: "new ticket",
      href: "/support/tickets/new",
      slice_text: " one-year ",
      slice_text_2: " 1,600 Miles (2,600 Kilometers) ",
      id: "5",
  ...
  SUSPENSION: [
    {
      name: "SUSPENSION",
      title_1: "Front and Rear suspension components are guaranteed for",
      title_2: " from the date of purchase or ",
      title_href: "new ticket",
      slice_text: " one year ",
      slice_text_2: " 1,600 Miles (2,600 Kilometers) ",
  ...
  Warranty_Exclusion: [
    ...
    },
    {
      name: "3. ACCIDENT",
      title:
        "Damage caused by accidents, neglect, or abuse. You should provide enough pictures requested by The Nireeka team as evidence.",
      id: "3",
    },
    {
      name: "4. ASSEMBLY FAULTS",
      title:
    ...
    {
      name: "5. MAINTENANCE",
      title: "Improper follow-up maintenance.",
      id: "5",
    },
    {
      name: "6. MODIFICATION",
    ...
    {
      name: "8. LABOR CHARGES",
      title: "Labor charges for part replacement or changeover",
      id: "8",
    },
    {
      name: "9. TRANSPORT CHARGES",
      title:
        "Transport charges for replacement parts or the bike if it's shipped to us for maintenance or repair.",
      id: "9",
    },
    {
      name: "10. BRANDED COMPONENTS",
      title:
  ...
  name_3: "What Voids Your bike's Warranty?",
  describe_3:
  ...
  void: [
    ...
    {
      name: "6. AFTERMARKET PARTS OR MODIFICATIONS",
      title:
    ...
    {
      name: "8. FOLLOWING The USER'S MANUAL",
      title:
