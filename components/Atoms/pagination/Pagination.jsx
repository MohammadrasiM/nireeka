    ...
    <nav className="flex items-center justify-between px-4 border-t border-gray-200 sm:px-0">
      <div className="flex flex-1 w-0 -mt-px">
        {!!(prevPageIndexInArray !== null) && (
          <Link href={props.noHref ? "" : props.links[prevPageIndexInArray]} passHref>
            <a
      ...
      <div className="hidden md:-mt-px md:flex">
        {pageIndexes.map((pageIndex, indexInArray) => {
          return (
            <Link key={`paginaiton-${indexInArray}`} href={!props.noHref ? props.links[indexInArray] : ""} passHref>
              <a
      ...
      <div className="flex justify-end flex-1 w-0 -mt-px">
        {!!(nextPageIndexInArray !== null) && (
          <Link href={props.noHref ? "" : props.links[nextPageIndexInArray]} passHref>
            <a
